...
<head>
<title>Camphila Herbals - Register</title>
  ...
  <div class="center_content">
    <div class="left_content">
      ...
      <div class="feat_prod_box_details">
        <p class="details">
		<b>Get Registered to our website and stay updated with our latest products.</b>
        <div class="contact_form">
          <div class="form_subtitle">create new account</div>
		  
		  <!-- Form Creation begins from here...-->
          <form name="register" method="POST" action="reg.php">
            <div class="form_row">
              <label class="contact"><strong>Username:</strong></label>
              <input type="text" class="contact_input" name="un" />
            </div>
            <div class="form_row">
              <label class="contact"><strong>Password:</strong></label>
              <input type="password" class="contact_input" name="pwd" />
            </div>
			<div class="form_row">
              <label class="contact"><strong>Confirm pass:</strong></label>
              <input type="password" class="contact_input" name="cpass"/>
            </div>
            <div class="form_row">
            ...
            <div class="form_row">
              <input type="submit" class="register" value="register" name="b1" />
            </div>
          </form>
        </div>
      </div>
    ...
    <div class="right_content">
      ...
      <div class="about">
        <p> <img src="images/about.gif" alt="" class="right" /> 
		The product has emerged with a view of producing 100% natural herbal products with an aim of providing glow and fairness to the skin. Each ingredients used in the product has been researched to provide glow and fairness to the skin and reduce freckles and marks. It helps to keep the skin young and beautiful. We use the most exquisite ingredients in the most optimum proportion to provide the best results.  
		</div>
      <div class="right_box">
